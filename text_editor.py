...
class TextEditor(QMainWindow, Ui_MainWindow):
    ...
    def setup_actions(self):
        ...
        self._remove_unused_analysis_actions()

    def _remove_unused_analysis_actions(self):
        for action_name in ('actionSemanticAnalysis', 'actionShowAST'):
            ...
            if hasattr(self, 'menuRun') and self.menuRun is not None:
                self.menuRun.removeAction(action)
    ...
    def apply_language(self):
        ...
        action_names = [
            ...
            'actionHelp', 'actionAbout', 'actionLanguage'
        ]
    ...
    def _update_output_tab_titles(self):
        if not hasattr(self, 'output_tab_widget') or self.output_tab_widget is None:
            return
        if self.resultTab is None or self.ErrorTab is None:
            return
    ...
    def fill_parser_table(self, errors, table=None):
        ...
        if errors:
            ...
            for row, error in enumerate(errors):
                ...
                kind_item = QTableWidgetItem(self.lang.translate('syntax_kind'))

    ...
    def __init__(self):
        self.translations = {
            "ru": {
                ...
                "actionSemanticAnalysis": "Внутреннее представление",
                "actionHelp": "Справка",
                ...
                "actionSemanticAnalysis_toolTip": "Построение тетрад и ПОЛИЗ",
                ...
                "semantic_analysis_input_empty": "Введите текст перед построением внутреннего представления",
                ...
                "value_not_available": "Вычисление доступно только для выражений из целых чисел",
                "division_by_zero": "Деление на ноль",
                "module_by_zero": "Делитель не может быть равен нулю",
                "ir_report_title": "Тетрады и ПОЛИЗ по строкам",
                ...
                "actionShowAST": "Показать цепочку вывода",
            },
            "en": {
                ...
                "actionSemanticAnalysis": "Intermediate representation",
                "actionHelp": "Help",
                "actionAbout": "About",
                ...
                "actionSemanticAnalysis_toolTip": "Build quadruples and RPN",
                ...
                "semantic_analysis_input_empty": "Enter text before building the intermediate representation",
                ...
                "value_not_available": "Evaluation is only available for integer-only expressions",
                "division_by_zero": "Division by zero",
                "module_by_zero": "Module by zero",
                "ir_report_title": "Quadruples and RPN per line",
                ...
                "actionShowAST": "Show derivation chain",
            },
        }
